...
describe("User login", () => {
  ...
  it("should be created successfully", () => {
    ...
    cy.contains(".btn-primary", "Add User").click({
    ...
    cy.contains(
      '#phone > .select-country-container > .country-selector > .country-selector__list > .vue-recycle-scroller > .vue-recycle-scroller__item-wrapper > [style="transform: translateY(16px);"] > .flex',
      country
    ).click();
    ...
    cy.get("#dropdown-right > .dropdown-menu > :nth-child(1) > .dropdown-item")
      .eq(0)
      .click();
    cy.wait(3000);
    ...
    cy.get("#dropdown-right > .dropdown-menu > :nth-child(2) > .dropdown-item")
      .eq(0)
      .click();
    cy.wait(3000);
    ...
    cy.contains(
      '[id^="__BVID__"][id$="___BV_tab_button__"] > .d-none',
      "Information"
    ).click();
    ...
    cy.get("#dropdown-right > .dropdown-menu > :nth-child(3) > .dropdown-item")
      .eq(0)
      .click();
    cy.wait(5000);
