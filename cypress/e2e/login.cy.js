...
describe('The Home Page', () => {
  ...
  // Sales
      ...
      cy.get('.navigation > :nth-child(8) > .d-flex').contains('Bank').click();

      cy.get('.navigation > :nth-child(9) > .d-flex').contains('Taxes').click();

      cy.get('.navigation > :nth-child(10) > .d-flex').contains('Stores').click();
