import "./commands";
describe("Sales invoice create", () => {
  beforeEach(() => {
    cy.login();
    cy.wait(4000);
  });

  it("should create the Sales invoice successfully", () => {
    cy.contains(".menu-title", "Sales").click(); // Click on user management
    cy.wait(3000);

    cy.get("#__BVID__129 > :nth-child(3) > .d-flex").click(); // Click on a user role
