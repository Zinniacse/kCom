...
describe("User login", () => {
  ...
  it("should be created successfully", () => {
    ...
    const mobileNumber = `1 (${randomNumber
      .toString()
      .substr(1, 3)}) ${randomNumber.toString().substr(4, 3)}-${randomNumber
      .toString()
      .substr(7, 4)}`;
    ...
    cy.contains(
      ".navigation > :nth-child(6) > :nth-child(1)",
      "Products"
    ).click();
    ...
    cy.contains(
      "#add-new-unit-sidebar > .b-sidebar-body > :nth-child(2) > .p-2 > .mt-2 > .mr-2",
      "Add"
    ).click();
    ...
    cy.contains(
      "#add-new-brand-sidebar > .b-sidebar-body > :nth-child(2) > .p-2 > .mt-2 > .mr-2",
      "Add"
    ).click();
    cy.wait(3000);
    ...
    // Upload file
    cy.contains(
      "#add-new-product-sidebar > .b-sidebar-body > :nth-child(2) > .px-2 > :nth-child(9) > .col > .media > .media-body > .d-flex > .btn-primary",
      "Upload"
    ...
    cy.get(
      ".d-flex.align-items-center.justify-content-start.mb-1.mb-md-0.col-md-4.col-12 input.d-inline-block.mr-1.form-control"
    ).type(product);
    cy.wait(5000);

    cy.contains("#dropdown-right__BV_toggle_", "Actions").click();
    cy.contains(
      "#dropdown-group-1 > :nth-child(1) > .dropdown-item",
      "Product Details"
    ).click();
